...
const config: CapacitorConfig = {
  ...
  server: {
    ...
    // historial", y muy probablemente también el login después de cerrar
    // sesión) aunque en la web normal funcionaran bien. Con esto el
  ...
  plugins: {
    ...
    StatusBar: {
      ...
      // encima del encabezado de la app.
